...
ssp1_2025_global <- rast("data/SSP1_RCP26/global_PFT_SSP1_RCP26_2025.tif")   #2025
ssp1_2030_global <- rast("data/SSP1_RCP26/global_PFT_SSP1_RCP26_2030.tif")   #2030
ssp1_2035_global <- rast("data/SSP1_RCP26/global_PFT_SSP1_RCP26_2035.tif")   #2035
ssp1_2040_global <- rast("data/SSP1_RCP26/global_PFT_SSP1_RCP26_2040.tif")   #2040
ssp1_2045_global <- rast("data/SSP1_RCP26/global_PFT_SSP1_RCP26_2045.tif")   #2045
ssp1_2050_global <- rast("data/SSP1_RCP26/global_PFT_SSP1_RCP26_2050.tif")   #2050


# read in projected SSP2 LULC for 2020 - 2050 -------------------------------------------
ssp2_2020_global <- rast("data/SSP2_RCP45/global_PFT_SSP2_RCP45_2020.tif") 
ssp2_2025_global <- rast("data/SSP2_RCP45/global_PFT_SSP2_RCP45_2025.tif")
ssp2_2030_global <- rast("data/SSP2_RCP45/global_PFT_SSP2_RCP45_2030.tif") 
ssp2_2035_global <- rast("data/SSP2_RCP45/global_PFT_SSP2_RCP45_2035.tif")
ssp2_2040_global <- rast("data/SSP2_RCP45/global_PFT_SSP2_RCP45_2040.tif")
ssp2_2045_global <- rast("data/SSP2_RCP45/global_PFT_SSP2_RCP45_2045.tif")
ssp2_2050_global <- rast("data/SSP2_RCP45/global_PFT_SSP2_RCP45_2050.tif")


# read in projected SSP3 LULC for 2020 - 2050 -------------------------------------------
ssp3_2020_global <- rast("data/SSP3_RCP70/global_PFT_SSP3_RCP70_2020.tif")  
ssp3_2025_global <- rast("data/SSP3_RCP70/global_PFT_SSP3_RCP70_2025.tif")  
ssp3_2030_global <- rast("data/SSP3_RCP70/global_PFT_SSP3_RCP70_2030.tif")  
ssp3_2035_global <- rast("data/SSP3_RCP70/global_PFT_SSP3_RCP70_2035.tif")  
ssp3_2040_global <- rast("data/SSP3_RCP70/global_PFT_SSP3_RCP70_2040.tif")  
ssp3_2045_global <- rast("data/SSP3_RCP70/global_PFT_SSP3_RCP70_2045.tif")  
ssp3_2050_global <- rast("data/SSP3_RCP70/global_PFT_SSP3_RCP70_2050.tif")  


# read in projected SSP4 LULC for 2020 - 2050 -------------------------------------------
ssp4_2020_global <- rast("data/SSP4_RCP60/global_PFT_SSP4_RCP60_2020.tif") 
ssp4_2025_global <- rast("data/SSP4_RCP60/global_PFT_SSP4_RCP60_2025.tif") 
ssp4_2030_global <- rast("data/SSP4_RCP60/global_PFT_SSP4_RCP60_2030.tif") 
ssp4_2035_global <- rast("data/SSP4_RCP60/global_PFT_SSP4_RCP60_2035.tif") 
ssp4_2040_global <- rast("data/SSP4_RCP60/global_PFT_SSP4_RCP60_2040.tif") 
ssp4_2045_global <- rast("data/SSP4_RCP60/global_PFT_SSP4_RCP60_2045.tif")
ssp4_2050_global <- rast("data/SSP4_RCP60/global_PFT_SSP4_RCP60_2050.tif") 


# read in projected SSP5 LULC for 2020 - 2050 -------------------------------------------
ssp5_2020_global <- rast("data/SSP5_RCP85/global_PFT_SSP5_RCP85_2020.tif") 
ssp5_2025_global <- rast("data/SSP5_RCP85/global_PFT_SSP5_RCP85_2025.tif")
ssp5_2030_global <- rast("data/SSP5_RCP85/global_PFT_SSP5_RCP85_2030.tif")
ssp5_2035_global <- rast("data/SSP5_RCP85/global_PFT_SSP5_RCP85_2035.tif")
ssp5_2040_global <- rast("data/SSP5_RCP85/global_PFT_SSP5_RCP85_2040.tif")
ssp5_2045_global <- rast("data/SSP5_RCP85/global_PFT_SSP5_RCP85_2045.tif")
ssp5_2050_global <- rast("data/SSP5_RCP85/global_PFT_SSP5_RCP85_2050.tif")
```
...
writeRaster(abandoned_ssp1, "data/SSP1_abandoned_cropland.tif")
writeRaster(abandoned_ssp2, "data/SSP2_abandoned_cropland.tif")
writeRaster(abandoned_ssp3, "data/SSP3_abandoned_cropland.tif")
writeRaster(abandoned_ssp4, "data/SSP4_abandoned_cropland.tif")
writeRaster(abandoned_ssp5, "data/SSP5_abandoned_cropland.tif")
```
